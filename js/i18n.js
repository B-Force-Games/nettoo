(() => {
  ...
  const ui = {
    ...
    'Antwoorden samen onthullen': 'Reveal answers together',
    'Maak een room': 'Create a room',
    'Seconden per ronde': 'Seconds per round',
    'Aantal rondes': 'Number of rounds',
    'Zichtbaarheid': 'Visibility',
    'Open — iedereen kan meedoen': 'Open — anyone can join',
    'Privé — alleen met roomcode': 'Private — room code only',
    'Room maken →': 'Create room →',
    ...
    'Spelers': 'Players',
    'Wachten tot de host start…': 'Waiting for the host to start…',
    'Start wedstrijd →': 'Start match →',
    'Room verlaten': 'Leave room',
    'Resterende tijd': 'Time left',
    'Inzendstatus': 'Submission status',
    'Iedereen klaar? De ronde begint zo.': 'Everyone ready? The round starts shortly.',
    'Antwoorden inleveren': 'Submit answers',
    'Wedstrijd verlaten': 'Leave match',
    'De onthulling': 'The reveal',
    'Antwoorden en tussenstand': 'Answers and standings',
    'Punten': 'Points',
    'Eindstand': 'Final standings',
    'Terug naar Live Rondes →': 'Back to Live Rounds →',
    'Verbinding herstellen… Je antwoorden blijven staan.': 'Reconnecting… Your answers stay in place.',
    ...
    'Breinkrakers': 'Find the Connection',
    ...
    'Schat het': 'Estimate',
    'slim.': 'smart.',
    'Drie antwoorden.': 'Three answers.',
    'Eén som.': 'One equation.',
    'Geef je antwoorden. Gebruik de som om ze scherper te maken.': 'Enter your answers. Use the equation to refine your guesses.',
    ...
    '← Alle Breinkrakers': '← All connections',
    ...
    'Puzzelregels': 'Puzzle rules',
    'Som moet kloppen': 'Equation must be correct',
    'Aan = je antwoorden moeten samen de formule vormen voordat je ze kunt inleveren.': 'On = your answers must form the equation before you can submit them.',
    'Drie exact juiste antwoorden vieren met confetti.': 'Celebrate three exactly correct answers with confetti.',
    ...
    'De gekozen set geldt vanaf je volgende solo-race. Daily-puzzels, Puzzels en Breinkrakers blijven onveranderd.': 'The selected set applies to your next solo race. Dailies, Puzzles and Find the Connection stay unchanged.',
    ...
    'Voortgang Breinkrakers': 'Find the Connection progress',
  ...
  const dynamicRules = [
    ...
    [/\bOpen Breinkraker\b/g, 'Open connection'],
